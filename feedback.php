...
<div class="col-lg-6">
<span class="another">Feedback Zone</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-6 panel" style="background-color:#808080  ; min-height:430px;">
<h2 align="center" style="font-family:'typo'; color:#000066">FEEDBACK/REPORT A PROBLEM</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
<h4>You can send us your feedback through e-mail on the following e-mail id:</h4><br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:stcetexamination@gmail.com" style="color:#000000">stcetexamination@gmail.com</a><br /><br />
</div><div class="col-md-1"></div></div>
<h4>Or you can directly submit your feedback by filling the entries below:</h4>
